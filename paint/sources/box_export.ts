...
let box_export_channels: string[]       = [
    "base_r", "base_g", "base_b", "height", "metal", "nor_r", "nor_g", "nor_g_directx", "nor_b", "occ", "opac", "rough", "smooth", "emis", "subs", "0.0", "1.0"
];
...
function box_export_tab_export_textures(title: string, bake_material: bool = false) {
	...
	if (ui_tab(box_export_htab, title, tab_vertical)) {
		...
		ui.enabled = context_raw.format_type == texture_ldr_format_t.JPG && base_bits_handle.i == texture_bits_t.BITS8;
