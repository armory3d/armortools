...
let upscale_node_temp: iron_g5_texture_t = null;
let upscale_node_image: iron_g5_texture_t = null;
...
function upscale_node_get_as_image(self: upscale_node_t, from: i32): iron_g5_texture_t {
	...
	if (upscale_node_image.width < config_get_texture_res_x()) {
		...
		while (upscale_node_image.width < config_get_texture_res_x()) {
			let last_image: iron_g5_texture_t = upscale_node_image;
			upscale_node_image = upscale_node_esrgan(upscale_node_image);
...
function upscale_node_get_cached_image(self: upscale_node_t): iron_g5_texture_t {
	return upscale_node_image;
}

function upscale_node_do_tile(source: iron_g5_texture_t): iron_g5_texture_t {
	let result: iron_g5_texture_t = null;
...
function upscale_node_esrgan(source: iron_g5_texture_t): iron_g5_texture_t {
	let result: iron_g5_texture_t = null;
	let size1w: i32 = source.width;
	let size1h: i32 = source.height;
