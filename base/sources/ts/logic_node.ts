...
type logic_node_t = {
	...
	get_as_image?: (self: any, from: i32)=>kinc_g5_texture_t;
	get_cached_image?: (self: any)=>kinc_g5_texture_t;
...
function logic_node_get_as_image(self: logic_node_t, from: i32): kinc_g5_texture_t {
...
function logic_node_get_cached_image(self: logic_node_t): kinc_g5_texture_t {
...
function logic_node_input_get_as_image(self: logic_node_input_t): kinc_g5_texture_t {
