...
let pipes_copy: iron_g5_pipeline_t;
let pipes_copy8: iron_g5_pipeline_t;
let pipes_copy128: iron_g5_pipeline_t;
let pipes_copy_bgra: iron_g5_pipeline_t;
let pipes_copy_rgb: iron_g5_pipeline_t = null;
let pipes_copy_r: iron_g5_pipeline_t;
let pipes_copy_g: iron_g5_pipeline_t;
let pipes_copy_a: iron_g5_pipeline_t;
let pipes_copy_a_tex: iron_g5_texture_unit_t;

let pipes_merge: iron_g5_pipeline_t = null;
...
let pipes_merge_mask: iron_g5_pipeline_t;

let pipes_invert8: iron_g5_pipeline_t;
let pipes_apply_mask: iron_g5_pipeline_t;
let pipes_colorid_to_mask: iron_g5_pipeline_t;

let pipes_tex0: iron_g5_texture_unit_t;
let pipes_tex1: iron_g5_texture_unit_t;
let pipes_texmask: iron_g5_texture_unit_t;
let pipes_texa: iron_g5_texture_unit_t;
let pipes_opac: iron_g5_constant_location_t;
let pipes_blending: iron_g5_constant_location_t;
let pipes_tex0_mask: iron_g5_texture_unit_t;
let pipes_texa_mask: iron_g5_texture_unit_t;
let pipes_tex0_merge_mask: iron_g5_texture_unit_t;
let pipes_texa_merge_mask: iron_g5_texture_unit_t;
let pipes_tex_colorid: iron_g5_texture_unit_t;
let pipes_texpaint_colorid: iron_g5_texture_unit_t;
let pipes_opac_merge_mask: iron_g5_constant_location_t;
let pipes_blending_merge_mask: iron_g5_constant_location_t;
let pipes_temp_mask_image: iron_g5_texture_t = null;

let pipes_inpaint_preview: iron_g5_pipeline_t;
let pipes_tex0_inpaint_preview: iron_g5_texture_unit_t;
let pipes_texa_inpaint_preview: iron_g5_texture_unit_t;

let pipes_cursor: iron_g5_pipeline_t;
let pipes_cursor_vp: iron_g5_constant_location_t;
let pipes_cursor_inv_vp: iron_g5_constant_location_t;
let pipes_cursor_mouse: iron_g5_constant_location_t;
let pipes_cursor_tex_step: iron_g5_constant_location_t;
let pipes_cursor_radius: iron_g5_constant_location_t;
let pipes_cursor_camera_right: iron_g5_constant_location_t;
let pipes_cursor_tint: iron_g5_constant_location_t;
let pipes_cursor_gbufferd: iron_g5_texture_unit_t;

function _pipes_make_merge(red: bool, green: bool, blue: bool, alpha: bool): iron_g5_pipeline_t {
	let pipe: iron_g5_pipeline_t = iron_g4_create_pipeline();
