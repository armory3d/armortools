...
declare function draw_rect(x: f32, y: f32, width: f32, height: f32, strength: f32): void;
declare function draw_line(x0: f32, y0: f32, x1: f32, y1: f32, strength: f32): void;
declare function draw_line_aa(x0: f32, y0: f32, x1: f32, y1: f32, strength: f32): void;
...
declare function draw_filled_circle(cx: f32, cy: f32, radius: f32, segments: i32): void;
declare function draw_circle(cx: f32, cy: f32, radius: f32, segments: i32, strength: f32): void;
declare function draw_cubic_bezier(x: f32[], y: f32[], segments: i32, strength: f32): void;
