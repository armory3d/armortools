...
declare function kinc_g5_clear(color: i32, depth: f32 = 0.0, flags: i32 = clear_flag_t.COLOR): void;
...
declare function kinc_mouse_lock(): void;
declare function kinc_mouse_unlock(): void;
declare function kinc_mouse_can_lock(): bool;
declare function kinc_mouse_is_locked(): bool;
declare function kinc_mouse_set_position(x: i32, y: i32): void;
...
declare function kinc_g4_set_vertex_buffer(buffer: any): void;
declare function iron_g4_draw_indexed_vertices(start: i32 = 0, count: i32 = -1): void;
declare function iron_g4_create_shader(data: buffer_t, type: i32): kinc_g5_shader_t;
declare function iron_g4_create_shader_from_source(source: string, shader_type: shader_type_t): kinc_g5_shader_t;
...
declare function iron_unload_image(image: kinc_g5_texture_t): void;
declare function iron_load_sound(file: string): any;
declare function kinc_a1_sound_destroy(sound: any): void;
declare function kinc_a1_play_sound(sound: any, loop: bool, pitch: f32, unique: bool): audio_channel_t;
declare function kinc_a1_stop_sound(sound: any): void;
declare function kinc_a1_channel_set_pitch(channel: audio_channel_t, pitch: f32): void;
declare function iron_load_blob(file: string): buffer_t;
declare function kinc_load_url(url: string): void;
declare function kinc_copy_to_clipboard(text: string): void;
...
declare function iron_g4_set_floats(location: any, values: f32_array_t): void;
...
declare function kinc_time(): f32;
declare function kinc_window_width(): i32;
declare function kinc_window_height(): i32;
declare function iron_set_window_title(title: string): void;
declare function kinc_window_get_mode(): i32;
declare function iron_set_window_mode(mode: i32): void;
declare function kinc_window_resize(width: i32, height: i32): void;
declare function kinc_window_move(x: i32, y: i32): void;
declare function iron_screen_dpi(): i32;
declare function kinc_system_id(): string;
declare function kinc_stop(): void;
declare function kinc_count_displays(): i32;
...
declare function kinc_g5_texture_generate_mipmaps(texture: any, levels: i32): void;
declare function iron_g4_set_mipmaps(texture: any, mipmaps: kinc_g5_texture_t[]): void;
declare function kinc_g5_render_target_set_depth_from(target: any, source: any): void;
declare function kinc_g4_viewport(x: i32, y: i32, width: i32, height: i32): void;
declare function kinc_g4_scissor(x: i32, y: i32, width: i32, height: i32): void;
declare function kinc_g4_disable_scissor(): void;
declare function iron_g4_begin(render_target: kinc_g5_texture_t, additional: kinc_g5_texture_t[] = null): void;
...
declare function kinc_internal_save_path(): string;
...
declare function draw_scaled_sub_image(image: kinc_g5_texture_t, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32, dw: f32, dh: f32): void;
declare function draw_sub_image(image: kinc_g5_texture_t, x: f32, y: f32, sx: f32, sy: f32, sw: f32, sh: f32): void;
declare function draw_scaled_image(image: kinc_g5_texture_t, dx: f32, dy: f32, dw: f32, dh: f32): void;
declare function draw_image(image: kinc_g5_texture_t, x: f32, y: f32): void;
...
declare function kinc_g5_raytrace_supported(): bool;
...
declare function iron_raytrace_set_textures(tex0: kinc_g5_texture_t, tex1: kinc_g5_texture_t, tex2: kinc_g5_texture_t, texenv: any, tex_sobol: any, tex_scramble: any, tex_rank: any): void;
declare function iron_raytrace_dispatch_rays(target: any, cb: buffer_t): void;

declare function kinc_window_x(): i32;
declare function kinc_window_y(): i32;
declare function kinc_language(): string;
...
declare type kinc_g5_constant_location_t = any;
declare type kinc_g5_texture_unit_t = any;
