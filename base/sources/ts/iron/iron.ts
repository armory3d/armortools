...
declare function kinc_g5_texture_unlock(texture: any): void;
...
declare function iron_g4_begin(render_target: image_t, additional: image_t[] = null): void;
...
declare function draw_scaled_sub_image(image: image_t, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32, dw: f32, dh: f32): void;
declare function draw_sub_image(image: image_t, x: f32, y: f32, sx: f32, sy: f32, sw: f32, sh: f32): void;
declare function draw_scaled_image(image: image_t, dx: f32, dy: f32, dw: f32, dh: f32): void;
declare function draw_image(image: image_t, x: f32, y: f32): void;
