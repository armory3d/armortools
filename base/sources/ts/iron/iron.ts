...
declare function iron_g5_clear(color: i32, depth: f32 = 0.0, flags: i32 = clear_flag_t.COLOR): void;
...
declare function iron_g4_index_buffer_unlock_all(buffer: any): void;
declare function iron_g4_set_index_buffer(buffer: any): void;
declare function iron_g4_create_vertex_buffer(count: i32, structure: iron_g5_vertex_structure_t, usage: i32): any;
...
declare function iron_g4_vertex_buffer_unlock_all(buffer: any): void;
declare function iron_g4_set_vertex_buffer(buffer: any): void;
declare function iron_g4_draw_indexed_vertices(start: i32 = 0, count: i32 = -1): void;
declare function iron_g4_create_shader(data: buffer_t, type: i32): iron_g5_shader_t;
declare function iron_g4_create_shader_from_source(source: string, shader_type: shader_type_t): iron_g5_shader_t;
declare function iron_g5_shader_destroy(shader: iron_g5_shader_t): void;
...
declare function iron_g5_set_pipeline(pipeline: any): void;
declare function iron_load_image(file: string, readable: bool): any;
declare function iron_unload_image(image: iron_g5_texture_t): void;
...
declare function _iron_g4_set_texture(stage: any, texture: any): void;
...
declare function _iron_g4_set_bool(location: any, value: bool): void;
declare function _iron_g4_set_int(location: any, value: i32): void;
declare function _iron_g4_set_float(location: any, value: f32): void;
declare function _iron_g4_set_float2(location: any, value1: f32, value2: f32): void;
declare function _iron_g4_set_float3(location: any, value1: f32, value2: f32, value3: f32): void;
declare function _iron_g4_set_float4(location: any, value1: f32, value2: f32, value3: f32, value4: f32): void;
declare function _iron_g4_set_floats(location: any, values: f32_array_t): void;
declare function _iron_g4_set_matrix4(location: any, matrix: mat4_t): void;
declare function _iron_g4_set_matrix3(location: any, matrix: mat3_t): void;
...
declare function iron_g4_create_render_target(width: i32, height: i32, format: i32 = tex_format_t.RGBA32, depth_buffer_bits: i32 = 0): any;
declare function iron_g4_create_texture_from_bytes(data: buffer_t, width: i32, height: i32, format: i32 = tex_format_t.RGBA32, readable: bool = true): any;
declare function iron_g4_create_texture_from_encoded_bytes(data: buffer_t, format: string, readable: bool = false): any;
declare function iron_g4_get_texture_pixels(texture: any): buffer_t;
declare function iron_g5_texture_generate_mipmaps(texture: any, levels: i32): void;
declare function iron_g4_set_mipmaps(texture: any, mipmaps: iron_g5_texture_t[]): void;
declare function iron_g5_render_target_set_depth_from(target: any, source: any): void;
...
declare function _iron_g4_begin(render_target: iron_g5_texture_t, additional: iron_g5_texture_t[] = null): void;
declare function _iron_g4_end(): void;
...
declare function draw_scaled_image(image: iron_g5_texture_t, dx: f32, dy: f32, dw: f32, dh: f32): void;
declare function draw_image(image: iron_g5_texture_t, x: f32, y: f32): void;
...
declare function iron_g5_raytrace_supported(): bool;
...
declare function iron_raytrace_set_textures(tex0: iron_g5_texture_t, tex1: iron_g5_texture_t, tex2: iron_g5_texture_t, texenv: any, tex_sobol: any, tex_scramble: any, tex_rank: any): void;
...
function g4_vertex_struct_create(): iron_g5_vertex_structure_t {
	let raw: iron_g5_vertex_structure_t = {};
	return raw;
}

function g4_vertex_struct_add(raw: iron_g5_vertex_structure_t, name: string, data: vertex_data_t) {
	let e: iron_g5_vertex_element_t = ADDRESS(ARRAY_ACCESS(raw.elements, raw.size));
	e.name = name;
	e.data = data;
	raw.size++;
}

declare function iron_g5_vertex_struct_size(s: iron_g5_vertex_structure_t): i32;
declare function iron_g5_vertex_data_size(data: vertex_data_t);

declare type iron_g5_pipeline_t = {
	input_layout?: any;
	vertex_shader?: any;
	fragment_shader?: any;
...
declare type iron_g5_shader_t = {
	impl?: any;
};

declare type iron_g5_vertex_element_t = {
	name?: string;
	data?: vertex_data_t;
};

declare type iron_g5_vertex_structure_t = {
	elements?: any; // iron_g5_vertex_element_t[IRON_G5_MAX_VERTEX_ELEMENTS];
	size?: i32;
};

declare type iron_g5_index_buffer_t = {
	impl?: any;
};

declare type iron_g5_vertex_buffer_t = {
	impl?: any;
};

declare type iron_g5_constant_location_t = any;
declare type iron_g5_texture_unit_t = any;
