...
declare function iron_set_mouse_wheel_callback(callback: (delta: f32) => void): void;
...
declare function iron_mouse_show(): void;
declare function iron_mouse_hide(): void;

declare function gpu_delete_buffer(buffer: any): void;
...
declare function _gpu_begin(render_target: gpu_texture_t, additional: gpu_texture_t[] = null, depth_buffer: gpu_texture_t = null,
                            flags: gpu_clear_t = gpu_clear_t.NONE, color: i32 = 0, depth: f32 = 0.0): void;
...
declare let ui_touch_control: bool;
declare let ui_touch_speed: f32;
...
declare let ui_nodes_on_node_changed: any;
...
declare enum ui_layout_t {
	VERTICAL,
	HORIZONTAL,
}

declare enum ui_align_t {
	LEFT,
	CENTER,
	RIGHT,
}

declare enum ui_state_t {
	IDLE,
	STARTED,
	DOWN,
	RELEASED,
