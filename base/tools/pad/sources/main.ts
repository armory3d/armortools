...
function main() {
	...
	let ops: iron_window_options_t = {
		...
		features : iron_window_features_t.RESIZABLE | iron_window_features_t.MAXIMIZABLE | iron_window_features_t.MINIMIZABLE,
	...
	let ui_ops: ui_options_t = {scale_factor : 1.0, theme : theme, font : font};
	ui                       = ui_create(ui_ops);
