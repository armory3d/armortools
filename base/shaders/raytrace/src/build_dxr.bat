...
.\dxc.exe -Zpr -Fo ..\raytrace_brute_forge_core.cso -T lib_6_3 .\raytrace_brute.hlsl -D _FORGE
.\dxc.exe -Zpr -Fo ..\raytrace_brute_forge_full.cso -T lib_6_3 .\raytrace_brute.hlsl -D _FORGE -D _FULL
